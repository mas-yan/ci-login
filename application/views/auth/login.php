                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="">
                                    <div class="form-group">
                                        <input type="text" value="<?= set_value('email') ?>" name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
